  ...
  return (
    <div className="min-h-screen bg-[#010409]/80 relative selection:bg-blue-500/30 flex items-center justify-center p-0 md:p-4">
      <main className="relative z-10 w-[1280px] max-w-full flex flex-col text-[#e6edf3] h-[100dvh] md:h-auto">
        <div className="bg-[#010409]/80 backdrop-blur-md p-4 sm:p-6 md:p-8 border-0 md:border border-white/10 rounded-none md:rounded-2xl flex flex-col gap-6 md:gap-8 h-full md:h-[clamp(60vh,100vh-20vw,95vh)] overflow-y-auto">
          <RepoHeader />
